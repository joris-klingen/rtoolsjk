...
```
Laad de relevante packages en de rtools in. Als je veel functies in je script schrijft, kun je ervoor kiezen deze in een apart script te zetten en dat script hier in te laden met `source()`.
```
# load packages ----------------------------------------------
libary(tidyverse)
